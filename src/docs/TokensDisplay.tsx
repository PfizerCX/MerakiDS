...
const ELEVATION_TOKENS = [
  { token: '--elevation-top-s', value: '0 -8px 20px 0 rgba(0, 0, 0, 0.08)' },
  { token: '--elevation-top-m', value: '0 -16px 40px 0 rgba(0, 0, 0, 0.08)' },
  { token: '--elevation-center-s', value: '0 0 20px 0 rgba(0, 0, 0, 0.08)' },
  { token: '--elevation-center-m', value: '0 0 32px 0 rgba(0, 0, 0, 0.08)' },
  { token: '--elevation-center-s-active', value: '0 0 24px 0 rgba(0, 0, 0, 0.16)' },
  { token: '--elevation-center-m-active', value: '0 0 40px 0 rgba(0, 0, 0, 0.16)' },
  { token: '--elevation-bottom-s', value: '0 8px 20px 0 rgba(0, 0, 0, 0.08)' },
  { token: '--elevation-bottom-m', value: '0 16px 40px 0 rgba(0, 0, 0, 0.08)' },
];

export function ShadowScale() {
  return (
    <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
      {ELEVATION_TOKENS.map((s) => (
