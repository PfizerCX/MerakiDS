...
const meta: Meta<typeof DateSegmented> = {
  ...
  argTypes: {
    ...
    monthPlaceholder: { table: { disable: true } },
    datePlaceholder: { table: { disable: true } },
    yearPlaceholder: { table: { disable: true } },
    minYear: { table: { disable: true } },
    maxYear: { table: { disable: true } },
